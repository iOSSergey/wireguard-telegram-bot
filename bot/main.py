    ...
    try:
        if primary == 'wireguard':
            ...
            instruction = (
                ...
                "🤖 <b>Android:</b>\n"
                "• <a href='https://play.google.com/store/apps/details?id=dev.hexasoftware.v2box'>v2box - v2ray client</a> (Рекомендуем)\n"
                "• <a href='https://github.com/2dust/v2rayNG/releases'>v2rayNG</a>\n\n"
                "🍏 <b>macOS:</b>\n"
                "• <a href='https://apps.apple.com/app/v2box-v2ray-client/id6446814690'>v2box - v2ray client</a> (Рекомендуем)\n"
